  ...
  public partial class InitialMigration : Migration
  {
    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
      ...
      migrationBuilder.CreateTable(
          ...
          constraints: table =>
          {
            table.PrimaryKey("PK_ConfirmationNumbers", x => x.Id);
            table.ForeignKey(
                      name: "FK_ConfirmationNumbers_Users_UserId",
                      column: x => x.UserId,
      ...
      migrationBuilder.CreateTable(
          ...
          constraints: table =>
          {
            ...
            table.ForeignKey(
                      name: "FK_ShippingCosts_Municipalities_MunicipalityId",
                      column: x => x.MunicipalityId,
                      principalTable: "Municipalities",
                      principalColumn: "Id",
                      onDelete: ReferentialAction.Cascade);
            table.ForeignKey(
                      name: "FK_ShippingCosts_VehicleTypes_VehicleTypeId",
                      column: x => x.VehicleTypeId,
                      principalTable: "VehicleTypes",
                      principalColumn: "Id",
                      onDelete: ReferentialAction.Cascade);
      ...
      migrationBuilder.CreateTable(
          ...
          columns: table => new
          {
            ...
            CourierUserId = table.Column<int>(type: "integer", nullable: true),
            ...
            TotalProductsCost = table.Column<decimal>(type: "numeric", nullable: false),
      ...
      migrationBuilder.CreateTable(
          ...
          constraints: table =>
          {
            ...
            table.ForeignKey(
                      name: "FK_ShoppingCarts_UserAddresses_UserAddressId",
                      column: x => x.UserAddressId,
                      principalTable: "UserAddresses",
                      principalColumn: "Id",
                      onDelete: ReferentialAction.Cascade);
      ...
      migrationBuilder.CreateIndex(
          name: "IX_ConfirmationNumbers_UserId",
      ...
      migrationBuilder.CreateIndex(
          name: "IX_ShippingCosts_MunicipalityId",
          table: "ShippingCosts",
          column: "MunicipalityId");

      migrationBuilder.CreateIndex(
          name: "IX_ShippingCosts_VehicleTypeId",
          table: "ShippingCosts",
      ...
      migrationBuilder.CreateIndex(
          name: "IX_ShoppingCarts_UserAddressId",
          table: "ShoppingCarts",
          column: "UserAddressId");
