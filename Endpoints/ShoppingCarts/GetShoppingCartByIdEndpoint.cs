...
public class GetShoppingCartByIdEndpoint : EndpointWithoutRequest<Results<Ok<ShoppingCartResponse>, NotFound,UnauthorizedHttpResult, ProblemDetails>>
{
  private readonly AppDbContext _dbContext;
  private readonly IBlobService _blobService;


  public GetShoppingCartByIdEndpoint(AppDbContext dbContext, IBlobService blobService)
  {
  ...
  public override async Task<Results<Ok<ShoppingCartResponse>, NotFound, UnauthorizedHttpResult, ProblemDetails>> ExecuteAsync(CancellationToken ct)
  {
    ...
    var existingShoppingCart = await _dbContext.ShoppingCarts.FirstOrDefaultAsync(x => x.Id == userId, ct);
