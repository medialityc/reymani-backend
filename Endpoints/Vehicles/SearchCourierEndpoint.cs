...
public class SearchCourierEndpoint : Endpoint<SearchVehiclesRequest, Results<Ok<PaginatedResponse<VehicleResponse>>, ProblemDetails>>
{
  private readonly AppDbContext _dbContext;
  private readonly IBlobService _blobService;

  public SearchCourierEndpoint(AppDbContext dbContext, IBlobService blobService)
  {
