...
public class GetByIdVehicleTypeCourierEndpoint : Endpoint<GetByIdRequest, Results<Ok<VehicleTypeResponse>, NotFound, ProblemDetails>>
{
  private readonly AppDbContext _dbContext;
  private readonly IBlobService _blobService;

  public GetByIdVehicleTypeCourierEndpoint(AppDbContext dbContext, IBlobService blobService)
  {
