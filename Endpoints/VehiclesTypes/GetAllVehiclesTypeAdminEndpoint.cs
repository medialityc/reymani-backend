...
public class GetAllVehiclesTypeAdminEndpoint : EndpointWithoutRequest<Results<Ok<IEnumerable<VehicleTypeResponse>>, ProblemDetails>>
{
  private readonly AppDbContext _dbContext;
  private readonly IBlobService _blobService;

  public GetAllVehiclesTypeAdminEndpoint(AppDbContext dbContext, IBlobService blobService)
  {
