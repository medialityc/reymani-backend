...
public class DBContext : DbContext
{
    ...
    public DbSet<NegocioUsuario> NegociosUsuarios { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Usuario>()
            .HasMany(c => c.Roles)
            .WithOne(cr => cr.Usuario)
            .HasForeignKey(cr => cr.IdUsuario)
            .OnDelete(DeleteBehavior.Cascade);
        ...
        modelBuilder.Entity<NegocioUsuario>()
        ...
        modelBuilder.Entity<UsuarioRol>()
            .HasKey(cr => cr.IdUsuarioRol);
        modelBuilder.Entity<RolPermiso>()
            .HasKey(rp => rp.IdRolPermiso);
        modelBuilder.Entity<NegocioUsuario>()
            .HasKey(nc => nc.IdNegocioUsuario);
